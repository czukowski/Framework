 ...
 * @license    MIT License
 * 
 * @property  PropertyAccessObject  $object
 */
class PropertyAccessObjectTest extends Testcase
{
	/**
	 * Tests array access methods from `PropertyAccess` trait by asserting key not
